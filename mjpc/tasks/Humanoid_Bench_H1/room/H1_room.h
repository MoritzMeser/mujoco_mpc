...
namespace mjpc {
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/room/H1_room_pos.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/room/H1_room_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/room/H1_room_gripper.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/room/H1_room_simple_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/room/H1_room_strong.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/room/H1_room_touch.xml");
        }
    };
}  // namespace mjpc
