...
// ------------------------------------------------------------ //
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/maze/H1_maze_pos.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/maze/H1_maze_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/maze/H1_maze_gripper.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/maze/H1_maze_simple_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/maze/H1_maze_strong.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/maze/H1_maze_touch.xml");
        }
    };
}  // namespace mjpc
