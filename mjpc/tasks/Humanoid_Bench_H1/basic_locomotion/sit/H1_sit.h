...
namespace mjpc {
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/sit/H1_sit_pos.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/sit/H1_sit_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/sit/H1_sit_gripper.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/sit/H1_sit_simple_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/sit/H1_sit_strong.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/sit/H1_sit_touch.xml");
        }
    };
}  // namespace mjpc
