...
namespace mjpc {
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/slide/H1_slide_pos.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/slide/H1_slide_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/slide/H1_slide_gripper.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/slide/H1_slide_simple_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/slide/H1_slide_strong.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/slide/H1_slide_touch.xml");
        }
    };
}  // namespace mjpc
