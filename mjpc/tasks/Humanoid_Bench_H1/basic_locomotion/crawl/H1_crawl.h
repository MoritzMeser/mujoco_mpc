...
namespace mjpc {
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/crawl/H1_crawl_pos.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/crawl/H1_crawl_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/crawl/H1_crawl_gripper.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/crawl/H1_crawl_simple_hand.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/crawl/H1_crawl_strong.xml");
        }
    };
    ...
    public:
        ...
        std::string XmlPath() const override {
            return GetModelPath("Humanoid_Bench_H1/basic_locomotion/crawl/H1_crawl_touch.xml");
        }
    };
}  // namespace mjpc
